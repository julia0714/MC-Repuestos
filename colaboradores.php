                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <div class="form-outline form-white mb-4">
                                    ...
                                    <input type="email" id="typeEmailX" placeholder="Introduce aqui Usuario..." class="form-control form-control-lg" />
                                </div>

                                <div class="form-outline form-white mb-4">
                                    <label class="form-label" for="typePasswordX">Contraseña</label>
                                    <input type="password" id="typePasswordX" placeholder="Introduce aqui Contraseña..." class="form-control form-control-lg" />
                                </div>
                                <div class="d-flex justify-content-center align-items-center flex-column">
                                    <p class="small pb-lg-2 "><a class="fs-6 p-colors" href="#!">¿Has olvidado tu contraseña?</a></p>
                                    <button class="btn btn-outline-light btn-lg px-5 btn-iniciar" type="submit">Iniciar</button>
                                </div>
